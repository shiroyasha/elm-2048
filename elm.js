      ...
      return function () {
         ...
         {case 0: return A3($Color.rgb,
            ...
            case 2048: return A3($Color.rgb,
              ...
              3);}
         _U.badCase($moduleName,
         "between lines 112 and 124");
      }();
   };
   var Merge = function (a) {
      return {ctor: "Merge",_0: a};
   };
      ...
      return function () {
         ...
         return function () {
            ...
            {case "Appearing":
               ...
               case "Moving":
               return function () {
                    var base = $Graphics$Collage.move(model.position)(A3($Shapes.roundedSquare,
                    model.size,
                    3,
                    backgroungColor(0)));
...
Elm.Units = Elm.Units || {};
Elm.Units.make = function (_elm) {
   "use strict";
   _elm.Units = _elm.Units || {};
   if (_elm.Units.values)
...
Elm.Views = Elm.Views || {};
Elm.Views.Objective = Elm.Views.Objective || {};
Elm.Views.Objective.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.Objective = _elm.Views.Objective || {};
   if (_elm.Views.Objective.values)
   return _elm.Views.Objective.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Views.Objective",
   $Basics = Elm.Basics.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var render = A2($Html.toElement,
   350,
   70)(A2($Html.p,
   _L.fromArray([]),
   _L.fromArray([A2($Html.span,
                _L.fromArray([]),
                _L.fromArray([$Html.text("Join the numbers and get to the")]))
                ,A2($Html.strong,
                _L.fromArray([]),
                _L.fromArray([$Html.text(" 2048 tile!")]))])));
   _elm.Views.Objective.values = {_op: _op
                                 ,render: render};
   return _elm.Views.Objective.values;
};
Elm.Views = Elm.Views || {};
